...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'zeus.Build.TemplateContainers.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('zeus.Build.TemplateContainers.refresh', callback);
		},
		onContainersModified: function(callback) {
			on('zeus.Build.Containers.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v3/js/zeus-templates/api/Build/TemplateContainers.js';
	var containerOptionsApi = '../../../../../../../../../../services/v3/js/zeus-templates/api/Build/Containers.js';
