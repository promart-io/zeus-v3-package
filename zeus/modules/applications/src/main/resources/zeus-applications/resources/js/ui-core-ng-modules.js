...
.service('Perspectives', ['$resource', function($resource){
	return $resource('/services/v3/js/zeus-applications/api/shell/perspectives.js');
}])
.service('Menu', ['$resource', function($resource){
	return $resource('/services/v3/js/zeus-applications/api/shell/menu.js');
}])
...
.factory('viewRegistry', ['ViewRegistrySvc', '$resource', 'ViewFactories', function(ViewRegistrySvc, $resource, ViewFactories){
	...
	var get = function(){
		return $resource('/services/v3/js/zeus-applications/api/shell/views.js').query().$promise
				.then(function(data){
...
.directive('menu', ['$resource', 'Theme', 'User', 'Layouts', 'messageHub', function($resource, Theme, User, Layouts, messageHub){
	return {
		...
		templateUrl: '/services/v3/web/zeus-applications/resources/templates/menu.html'
	}
}])
.directive('sidebar', ['Perspectives', function(Perspectives){
	return {
		...
		templateUrl: '/services/v3/web/zeus-applications/resources/templates/sidebar.html'
	}
}])
